...
import 'package:loginsignup/screens/backupyourwallet_7/restoringYou_4.dart';

class RestoringYou_3 extends StatelessWidget {
  @override
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text("Choose A PIN Code To Secure Your Details",
                  style:TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 15,
                      color: Colors.blue
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    width: 150,
                    child: Center(
                      child: GestureDetector(onTap: (){navigateTo(context, RestoringYou_4());},
                        child: Text(
                          "Confirm",
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
