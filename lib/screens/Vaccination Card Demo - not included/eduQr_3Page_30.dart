...
import 'package:loginsignup/screens/Vaccination%20Card%20Demo%20-%20not%20included/sharedSuccesfuly_Page_31.dart';
import 'package:loginsignup/screens/Vaccination%20Card%20Demo%20-%20not%20included/shared_Successfully1_Page_28.dart';

class EduQR_3Page_30 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {},
        child: Center(child: GestureDetector(onTap: (){navigateTo(context, SharedSucesfulyPage_31());},
...
"SCAN TO VERIFY",                      style: TextStyle(fontSize: 15,
                        color: Colors.black,
                        fontWeight: FontWeight.bold),)
                  ],),
