...
import 'package:loginsignup/screens/Payment%20(Not%20Active%20Yet)/bitcoinPage_12.dart';

class IPhoneX_Page_11 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {},
        child: Center(child: GestureDetector(onTap: (){navigateTo(context, BitcoinPage_12());},
